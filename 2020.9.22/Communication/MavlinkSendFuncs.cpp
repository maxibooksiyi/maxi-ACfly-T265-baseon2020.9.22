	...
	if( getReceiver(&rc) )
	{
		if( rc.available )
		{
			...
			mavlink_msg_rc_channels_pack_chan( 
				...
				rc.raw_data[0]*10 + 1000 ,
				rc.raw_data[1]*10 - 1000 ,
				rc.raw_data[2]*10 - 1000 , 
				rc.raw_data[3]*10 - 1000 ,
				rc.raw_data[4]*10 - 1000 ,
				rc.raw_data[5]*10 - 1000 , 
				rc.raw_data[6]*10 - 1000 ,
				rc.raw_data[7]*10 - 1000 ,
				rc.raw_data[8]*10 + 1000 ,
				rc.raw_data[9]*10 - 1000 ,
				rc.raw_data[10]*10 - 1000 , 
				rc.raw_data[11]*10 - 1000 ,
				rc.raw_data[12]*10 - 1000 ,
				rc.raw_data[13]*10 - 1000 , 
				rc.raw_data[14]*10 - 1000 ,
				rc.raw_data[15]*10 - 1000 ,
				UINT16_MAX,
				UINT16_MAX,
				255	//rssi
				);
