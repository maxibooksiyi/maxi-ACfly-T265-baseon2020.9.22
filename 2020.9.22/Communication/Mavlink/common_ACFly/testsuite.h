/** @file
 *    @brief MAVLink comm protocol testsuite generated from common_ACFly.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef COMMON_ACFLY_TESTSUITE_H
#define COMMON_ACFLY_TESTSUITE_H
...
static void mavlink_test_common_ACFly(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_common_ACFly(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_common_ACFly(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // COMMON_ACFLY_TESTSUITE_H
